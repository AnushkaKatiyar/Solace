    ...
    if "final_plan" in st.session_state and st.session_state.final_plan is not None:
        ...
        st.markdown(
                ...
                <div style="
                    ...
                    background-color: #cce6ff;  /* nice blue tab color */
                    color: white;
                    font-size: 20px;
                    font-weight: bold;
        ...
        st.markdown(
            """
            <div style="margin-top: 30px; font-size: 15px; color: grey; font-style: italic;">
                <b>Note:</b> These predictions are generated by a machine learning model trained on historical school construction data.<br>
                The model has a Root Mean Square Error (RMSE) of ±$651,000 and explains about 98.8% of the variation in cost (R² = 0.988).<br>
                Actual costs may vary depending on project-specific factors not captured in the data.
            </div>
            """,
            unsafe_allow_html=True
        )
